...
export default function LinkedinLogo ({ id, color, onClick }: Props): ReactElement
{
    return (
        <a href="https://www.linkedin.com/in/antonioacunab/" target="_blank">
            <svg id={id} x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" onClick={() => onClick()}>
